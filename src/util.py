...
def get_steer_angle(fits):
    ...
    # if len_fit == 3:
    #     y = 20
    #     x = (np.poly1d(fits[-1])(y) + np.poly1d(fits[-2])(y)) // 2 + 40
    ...
    #     return return_value
        ...
        #y = 20
        y = 120
        x = (np.poly1d(fits[-1])(y) + np.poly1d(fits[-2])(y)) // 2 - 35 
        return_value = errorAngle((x,y))
...
def calcul_speed(steer_angle, max_speed, max_angle):
    # if steer_angle == -10 or steer_angle == 10:
    #     return 0
